...
/**
 * ReserveMetalsSearch represents the model behind the search form of `app\models\ReserveMetals`.
 */
class ReserveMetalsSearch extends ReserveMetals
{
    /**
     * {@inheritdoc}
     */
